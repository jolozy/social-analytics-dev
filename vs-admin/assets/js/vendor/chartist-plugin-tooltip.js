    ...
    Chartist.plugins.tooltip = function (options) {
      ...
      return function tooltip(chart) {
        ...
        function setPosition(event) {
          ...
          // Hotfix by Her Laang. Due to position absolute element in position relative parent.
          // event.offsetX will be from body instead of parent div
          // Solution: get <section> marginLeft and add it to the calculation
          // var p = document.getElementsByClassName("bg")[0].childNodes[1];
          // var style = window.getComputedStyle(p);
          // var marginLeft = parseInt(style.marginLeft, 10);
          // Hotfix commented out on 1 March 2016
