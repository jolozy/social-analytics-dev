    ...
    <div class="panel panel-dark panel-alt">
        ...
        <div class="panel-body form form-horizontal">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <input type="text" class="form-control" placeholder="Title" id="partner-video-id" name="partner-video-id" readonly/>
            </div>
          </div><!-- form-group -->
          ...
          <div class="form-group">
            ...
            <div class="col-sm-7 control-label">
              <div id="partner-video-published" class="toggle toggle-success"></div>
            </div>
          </div>

        </div>
        <div class="panel-footer">
          <button aria-hidden="true" class="pull-right btn btn-success js-partner-video-submit-btn" type="button">Save</button>
