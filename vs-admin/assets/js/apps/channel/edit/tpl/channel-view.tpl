<div class="pageheader">
  <h2><i class="fa fa-video-camera"></i> Channel
  <span>Edit Channel Information...</span>
...
<div class="contentpanel">
    <div class="row">
        <div class="col-md-12 channel-edit">
        <ul class="nav nav-tabs js-channel-tabs">
          <li><a data-toggle="tab" href="#basic" class=".js-channel-tab">Basic Info</a></li>
          <li><a data-toggle="tab" href="#advanced" class=".js-channel-tab">Channel Info</a></li>
          <li><a data-toggle="tab" href="#editions" class=".js-channel-tab">Editions</a></li>
          <li><a data-toggle="tab" href="#images" class=".js-channel-tab">Images</a></li>
        </ul>
            ...
            <div class="tab-pane" id="basic">
              ...
              <form class="form form-horizontal form-bordered">
                <div class="form-group">
                  ...
                  <div class="row">
                    <label class="col-sm-3 control-label" for="channel_url">Friendly URL</label>
                    <div class="col-sm-6">
                      <input type="text" placeholder="Friendly URL" class="form-control" id="channel_url" name="channel_url"/>
                      <span class="help-block">A url friendly version of the channel title...</span>
                    </div>
                  </div>
                  <div class="row">
              ...
              <thead>
                <tr>
                  ...
                  <th class="table-action">
                    <a class="js-new-channel-edition-btn">
                        <i class="fa fa-plus"></i>
                    </a>
                  </th>
                </tr>
              </thead>
              <tbody class="js-channel-editions-container">
