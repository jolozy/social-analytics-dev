    ...
    <div class="modal-content">
        <div class="panel panel-dark panel-alt">
            <div class="panel-heading">
                <h3 class="panel-title">Schedule Email</h3>
                <p>Schedule a date for email to be sent</p>
            </div>
            ...
            <div class="panel-footer">
                <button aria-hidden="true" class="pull-right btn btn-success js-schedule-newsletter-submit-btn" type="button">Schedule Email</button>
