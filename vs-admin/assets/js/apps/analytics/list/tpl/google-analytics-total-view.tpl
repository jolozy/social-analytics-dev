<div class="pageheader">
    <h2><i class="fa fa-bar-chart-o"></i> Analytics
        <span>Google Analytics - MAU Total</span>
    </h2>
</div>
<div class="contentpanel">
    ...
    <div class="js-loading-container hidden mb20 mt20">
    ...
    <div class="total-mau-container stats-container mb20" style="padding: 20px;">

    </div>

    <div class="new-downloads-container stats-container mb20" style="padding: 20px;">

    </div>

    <div class="new-users-container stats-container mb20" style="padding: 20px;">

    </div>

    <div class="mobile-web-ratio-container stats-container mb20" style="padding: 20px;">
