...
<div class="contentpanel">
    ...
    <div class="row mb20">
        <div class="col-lg-12 col-md-12">
          <div class="table-responsive overall-stats-container stats-container">
    ...
    <div class="row mb20">
            <div class="col-lg-12 col-md-12">
              <div class="table-responsive overall-trends-container stats-container">
    ...
    <div class="row mb20">
        <div class="col-lg-12 col-md-12">
          <div class="table-responsive tracker-stats-container stats-container">
    ...
    <div class="row mb20">
        <div class="col-lg-12 col-md-12">
          <div class="table-responsive growth-stats-container stats-container">
    ...
    <div class="row mb20">
        <div class="col-lg-12 col-md-12">
          <div class="table-responsive engagement-stats-container stats-container">
